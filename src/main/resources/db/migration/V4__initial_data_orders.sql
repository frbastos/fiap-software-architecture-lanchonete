INSERT INTO orders (id, customer_id, state, total_price, payment_confirmation_status, payment_id, creation_time, order_number) VALUES ('bc0eccdb-f1f4-4766-84aa-b41fda366a7f', null, 'PENDING', 51.0, 'PENDING', null, '2024-09-15 09:30',2000);
INSERT INTO orders (id, customer_id, state, total_price, payment_confirmation_status, payment_id, creation_time, order_number) VALUES ('8d50fed2-3861-40fb-ba78-f0911d3730ec', '8834adb8-193e-4bed-a0b6-f1aba4735509', 'PENDING', 67.0, 'PENDING', null, '2024-09-15 15:00', 1000);
