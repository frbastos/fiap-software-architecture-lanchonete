INSERT INTO orders (id, customer_id, state, total_price, payment_confirmation_status, payment_id, creation_time, order_number) VALUES (1, null, 'PENDING', 51.0, 'PENDING', null, '2024-09-15 09:30', 1);
INSERT INTO orders (id, customer_id, state, total_price, payment_confirmation_status, payment_id, creation_time, order_number) VALUES (2, 1, 'PENDING', 67.0, 'PENDING', null, '2024-09-15 15:00', 2);
