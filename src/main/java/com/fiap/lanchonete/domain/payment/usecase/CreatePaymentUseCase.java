...
import com.fiap.lanchonete.domain.payment.ports.out.SavePaymentOutputPort;
...
public class CreatePaymentUseCase implements CreatePaymentInputPort {
    ...
    public CreatePaymentUseCase(SavePaymentOutputPort savePaymentOutputPort) {
    ...
    public Payment createPayment(PaymentPersistence persistence) {
        ...
        return this.savePaymentOutputPort.save(payment);
    }
}
